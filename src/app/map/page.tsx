...
export default function MapPage() {
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="border-b border-amber-200 bg-gradient-to-b from-amber-50 to-white">
        ...
        <div className="px-6 py-5">
          ...
          <p className="mt-1 max-w-xl text-sm leading-relaxed text-amber-800 italic">
